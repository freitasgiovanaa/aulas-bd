/*create table Banco(id_banco serial primary key,
				  nome varchar(50))
				  
create type est_civil as enum('Solteiro','Casado', 
							  'Viuvo', 'Divorciado')
...
create table Pagamentos(id_pagamento serial primary key,
					    id_emprestimo int,
					   	foreign key (id_emprestimo) references 
...
values
    ...
    ('Rodrigo Gonçalves', '9987456320', 'Solteiro'),
    ...
    ('Tatiane Santos', '9512345678', 'Casado'),
...
insert into Emprestimo(id_cliente, id_banco, valor, taxa_juros, numero_parcelas)
values
    (1, 1, 10000.00, 0.05, 12),
    (2, 2, 15000.00, 0.06, 24),
    (3, 3, 20000.00, 0.04, 18),
    (4, 4, 12000.00, 0.07, 36),
    (5, 5, 18000.00, 0.08, 12),
    (6, 5, 25000.00, 0.05, 24),
    (7, 2, 30000.00, 0.06, 18),
    (8, 4, 22000.00, 0.04, 36),
    (9, 3, 28000.00, 0.07, 12),
    (10, 1, 35000.00, 0.08, 24),
    (20, 2, 25000.00, 0.05, 24),
    (21, 3, 32000.00, 0.07, 12),
    (22, 1, 38000.00, 0.08, 24),
    (23, 5, 45000.00, 0.06, 18),
    (24, 4, 29000.00, 0.04, 36),
    (25, 5, 42000.00, 0.07, 12),
    (26, 4, 50000.00, 0.08, 24),
    (27, 3, 35000.00, 0.05, 24),
    (28, 2, 43000.00, 0.07, 12),
    (29, 1, 48000.00, 0.08, 24),
    (30, 1, 38000.00, 0.06, 18),
    (40, 3, 55000.00, 0.07, 12),
    (41, 5, 60000.00, 0.08, 24),
    (42, 2, 45000.00, 0.06, 18),
    (43, 4, 52000.00, 0.04, 36),
    (44, 2, 68000.00, 0.07, 12),
    (45, 1, 72000.00, 0.08, 24),
    (46, 3, 59000.00, 0.06, 18),
    (47, 5, 64000.00, 0.04, 36),
    (48, 4, 75000.00, 0.07, 12),
    (49, 4, 82000.00, 0.08, 24),
    (50, 5, 69000.00, 0.06, 18),
	(51, 3, 55000.00, 0.07, 12),
    (52, 2, 60000.00, 0.08, 24),
    (53, 1, 45000.00, 0.06, 18),
    (54, 5, 52000.00, 0.04, 36),
    (55, 2, 68000.00, 0.07, 12),
    (56, 2, 72000.00, 0.08, 24),
    (41, 3, 59000.00, 0.06, 18),
    (3, 1, 64000.00, 0.04, 36),
    (18, 4, 75000.00, 0.07, 12),
    (50, 4, 82000.00, 0.08, 24),
    (7, 3, 69000.00, 0.06, 18),
    (26, 5, 55000.00, 0.07, 12),
    (17, 1, 60000.00, 0.08, 24),
    (55, 2, 45000.00, 0.06, 18),
    (25, 2, 52000.00, 0.04, 36),
    (38, 3, 68000.00, 0.07, 12),
    (44, 5, 72000.00, 0.08, 24),
    (27, 1, 59000.00, 0.06, 18),
    (35, 5, 64000.00, 0.04, 36),
    (10, 4, 75000.00, 0.07, 12),
    (30, 3, 82000.00, 0.08, 24),
    (20, 1, 69000.00, 0.06, 18),
    (6, 2, 55000.00, 0.07, 12),
    (8, 3, 60000.00, 0.08, 24),
    (19, 1, 45000.00, 0.06, 18),
    (2, 2, 52000.00, 0.04, 36),
    (10, 3, 68000.00, 0.07, 12),
    (3, 4, 72000.00, 0.08, 24),
    (9, 5, 59000.00, 0.06, 18),
    (8, 5, 64000.00, 0.04, 36);
...
values
    ...
    (57, '2028-09-15', 1600.00),
    (58, '2028-10-20', 1950.00),
    (59, '2028-11-25', 2200.00),
    (60, '2028-12-30', 1150.00),
    (61, '2029-01-05', 750.00),
    (62, '2029-02-10', 1000.00);
